...
def data_prepare_for_heatmap(pre_df, cut_line):
    ...
    pre_df2.sort_values(by='陕甘宁', axis=0, inplace=True, ascending=True)
    pre_df2.sort_values(by='陕甘宁', axis=1, inplace=True, ascending=True)
    return pre_df2
